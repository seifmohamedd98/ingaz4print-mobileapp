...
class FlyerMaker extends StatelessWidget {
  @override
...
class FlyerForm extends StatefulWidget {
  @override
  FlyerFormState createState() {
    return FlyerFormState();
  }
}

class FlyerFormState extends State<FlyerForm> {
  final _formKey = GlobalKey<FormState>();
  var papersize = ["Standard (50.8 x 88.9 mm)", "Small (40.8 x 66.3 mm)"];
  var sizeselect = "Select Paper Size";
  @override
  Widget build(BuildContext context) {
    return Form(
      key: _formKey,
