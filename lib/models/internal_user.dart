...
class InternalUser extends User
{
  ...
  InternalUser({email, username, password, mobile, access, uId, fname, lname, address}) : super(email: email, username: username, password: password, mobile: mobile, access: access, uId: uId)
  {
    this.fname=fname;
  ...
  {
    DocumentReference ref = FirebaseFirestore.instance.collection("paper_property").doc();
      ref.set({
        "id": ref.id,
        'type': type,
        'price': price,
  ...
  Future<void> addCategorySample(description, image, category) async
  {
    ...
    try{
      ...
      DocumentReference ref =  FirebaseFirestore.instance.collection("category_samples").doc();
      ref.set({
        'id': ref.id,
  ...
  {
      DocumentReference ref =  FirebaseFirestore.instance.collection("category").doc();
      ref.set({
        'name': name,
